...
STORAGES = {
    "default": {
        "BACKEND": "apps.storage.backends.ThumbnailFileSystemStorage",
    },
    "staticfiles": {
...
# Thumbnail sizes generated for every saved image (16:9 to match video frames).
# Generated by the django-storage-thumbnails package (thumbnail_storage.ThumbnailMixin),
# wired in via apps.storage.backends.
THUMBNAIL_SIZES = {
    "thumb": (320, 180),
    "small": (160, 90),
}
